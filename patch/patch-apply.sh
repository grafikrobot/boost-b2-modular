...
rm -f "${rootdir}/libs/statechart/Jamfile.v2"
rm -f "${rootdir}/libs/static_assert/Jamfile.v2"
rm -f "${rootdir}/libs/static_string/Jamfile"
rm -f "${rootdir}/libs/test/Jamfile.v2"
rm -f "${rootdir}/libs/tokenizer/Jamfile"
rm -f "${rootdir}/libs/url/Jamfile"
rm -f "${rootdir}/libs/uuid/Jamfile"
cd "${rootdir}"
echo "*****" `pwd`
